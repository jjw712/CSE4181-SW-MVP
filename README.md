...
- **프로젝트:** 소프트웨어공학 2인 팀 프로젝트
- **장지원 담당:** 외부 데이터 수집·정규화, Gemini 연동, 리포트 API와 화면을 연결하는 핵심 서비스 구현
- **핵심 설계:** 요약과 원문 출처를 연결하고, 미확인 정보와 API 실패를 구분해 처리
- **기술:** Python · FastAPI · Gemini · React

[백엔드 코드](backend/app/) · [프론트엔드 코드](frontend/src/) · [기능 범위와 제약](docs/limitations.md)
